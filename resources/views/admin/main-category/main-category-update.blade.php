<x-admin.admin-layout title="Main Category">
    ...
    <x-slot name="pageTitle">
        <x-admin.admin-page-title title="Main Category" subtitle="Update Main Category">
    ...
    <x-slot name="main">
        <div class="card">
            <div class="card-body">
                <form class="form" method="POST" action="/admin/main-category-update">
                    @csrf

                    @method('PUT')

                    <input type="hidden" name="category_id" value="{{ $mainCategory->category_id }}">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                type="text" name="category_logo" id="category_logo" placeholder="Category Logo"
                                value="{{ $mainCategory->category_logo }}">
                                @error('category_logo')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea
                                    @class(['form-control', 'is-invalid'=> $errors->has('category_description')]) name="category_description" id="category_description" rows="4"
                                    placeholder="Category Description">{{ $mainCategory->category_description }}</textarea>
