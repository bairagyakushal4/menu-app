<x-admin.admin-layout title="Report">
    <x-slot name="sidebar">
        <x-admin.admin-sidebar activeModule="report" activePage="report"></x-admin.admin-sidebar>
    </x-slot>

    <x-slot name="pageTitle">
        <x-admin.admin-page-title title="Report" subtitle="View Reports">
