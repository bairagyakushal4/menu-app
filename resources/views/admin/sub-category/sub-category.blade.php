        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3 text-end">
                    <a href="/admin/sub-category-create" class="btn btn-primary">Create Category</a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/sub-category-delete/{{ $row->category_id }}"
                                        class="btn icon btn-danger" onclick="deleteConfirm(this, event)"><i
